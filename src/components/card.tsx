...
const Card: React.FC<GalleryProps> = ({ gallery }) => {
    ...
    return (
        <MotionUp className="m-auto bg-cover w-[18.5rem] h-[18.5rem] flex flex-col justify-between bg-[#D9D9D9] rounded-2xl shadow-md" style={{ backgroundImage: `url(${gallery.imgurl})` }}>
            <div></div>
